...
<p><strong>Tech Stack:</strong> Python • Django • Pandas • Excel Automation</p>
<p>A web-based system that automatically generates REMC datapoints from substation and device metadata. 
The application streamlines Excel generation, formatting, device logic mapping, and file handling—reducing manual effort by over <strong>70%</strong>.</p>
